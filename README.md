...
Using Tableau's Data processing feature, i tried to join all the data into a single table which highlights all detials of every order in the database for each account.
### Data Model:
